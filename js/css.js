var css1 = {"\
	...
	<h6>Стили:</h6>\
	<p>hidden - Эквивалентно none.<br><br>\
			dotted - точечная рамка	<br><br>\
			dashed - пунктирная рамка<br><br>\
			solid	- сплошная рамка<br><br>\
			double - 	двойная рамка<br><br>\
			groove - внешняя тень на рамне<br><br>\
			ridge - внутренняя тень на рамке<br><br>\
			inset	- вогнутая рамка рамки<br><br>\
			outset - выгнутая рамка<br><br>\
	...
	<p>static - отображается обычно <br><br>\
			relative - занимает место, сдвигается относительно своей позиции top, right, bottom, left<br><br>\
			fixed - не занимает место, фиксируется на экране top, right, bottom, left<br><br>\
			absolute - не занимает место, сдвигается относительно тела документа top, right, bottom, left<br><br>\
	...
	<h4>overflow: #; </h4>\
	<p>отображение детей за пределами родителя<br><br>\
		auto — прокрутка добавляется лишь при необходимости<br><br>\
		hidden — отображает лишь внутренности<br><br>\
		scroll — всегда добавляет полосы прокрутки<br><br>\
		visible — отображает всё<br><br>\
	...
	<p>6 -size: x[,y]; - размер элемента<br><br>\
		auto - Если задано одновременно для ширины и высоты (auto auto), размеры фона остаются исходными; если только для одной стороны картинки (100px auto), то размер вычисляется автоматически исходя из пропорций картинки.<br><br>\
		cover - Масштабирует изображение с сохранением пропорций так, чтобы его ширина или высота	равнялась ширине или высоте блока.<br><br>\
		contain - Масштабирует изображение с сохранением пропорций таким образом,	чтобы картинка целиком поместилась внутрь блока.<br>\
	</p>\
	...
	<h4>x:checked </h4>\
	<p>выбирает выбранный по умолчанию пользователем элемент input с checked </p><br><br>\
	<h4>::first-letter </h4>\
